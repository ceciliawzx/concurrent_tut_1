...
#include "src/shared_mutexes/shared_mutex_fair_simple.h"
...
int main() {
  ...
  {
    SharedMutexFairSimple shared_mutex_fair_simple;
    RunBenchmark("Fair Simple", shared_mutex_fair_simple, 100, 8u, 100000u);
  }
  {
